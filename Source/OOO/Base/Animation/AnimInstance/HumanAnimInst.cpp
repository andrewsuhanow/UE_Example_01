...
void UHumanAnimInst::NativeUpdateAnimation(float DeltaTime)
{
	...
	FVector velocitySpeed = UnitOwner->GetVelocity();
	MoveSpeed = velocitySpeed.Size();
	Direction = CalculateDirection(velocitySpeed, UnitOwner->GetActorRotation());
	...
	// ++++++++++++++++++++++++++++++++++++++ LocomotionPose = UnitOwner->LocomotionPose;	// ** WREPE PLACED
