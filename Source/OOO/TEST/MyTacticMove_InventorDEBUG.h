...
UENUM()
enum class ETacticalAttackTEST : uint8
{
	/*
...
UENUM()
enum class ETacticalAttack_Side : uint8
{
	Front,
	Front_Left,
	Front_Right,
...
UCLASS()
class OOO_API AMyTacticMove_InventorDEBUG : public ADefaultPawn
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "OOO_001_SelectUnit")		FName SelectUnitName_2 = FName("Un2_TacticalMove");
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "OOO_004_Attack")		ETacticalAttackTEST TacticalAttackTEST;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "OOO_004_Attack")		ETacticalAttack_Side StandPositionOnTarget;
